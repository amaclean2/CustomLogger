...
describe('logging things works right', () => {
    ...
    it.skip('should output an error log to the console', async () => {
        const myLogger = new Logger('my-app');
    ...
    it.skip('should output an object to the console', async () => {
        const myLogger = new Logger('my-app');
    ...
    it.skip('should output an error block to the console', async () => {
        const myLogger = new Logger('my-app');
    ...
    it.skip('should output a warning message to the console', async () => {
        const myLogger = new Logger('my-app');
    ...
    it.skip('should output a debug message to the console', async () => {
        const myLogger = new Logger('my-app');
